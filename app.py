...
# Load YOLOv8 models
yolov8_road_damage = YOLO(r'models\best (8).pt')
yolov8_aerial = YOLO(r'models\arielview.pt')
yolov8_traffic_light = YOLO(r'models\best (7).pt')
yolov8_road_object = YOLO(r'models\yolov8n.pt')  # New model
deepsort = DeepSort()
